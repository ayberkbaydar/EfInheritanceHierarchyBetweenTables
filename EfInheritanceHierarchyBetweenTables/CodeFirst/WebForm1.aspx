...
<body>
    <form id="form1" runat="server">
        <div style="font-family: Arial">
            ...
            <br />
            <asp:Button ID="btnPermanent" runat="server" Text="Add Permanent Employee" OnClick="btnPermanent_Click" />
            <br />
            <asp:Button ID="btnContract" runat="server" Text="Add Contract Employee" OnClick="btnContract_Click" />
        </div>
    </form>
</body>
</html>
